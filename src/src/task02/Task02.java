package src.task02;
/*
Создайте программу, которая складывает  перемножает / вычитает / делит два числа
и выводит на экран результат. Оба числа и желаемая операция должны приходить в аргументах
Ввод: 12 40 sum
Вывод: 52
 */
public class Task02 {
